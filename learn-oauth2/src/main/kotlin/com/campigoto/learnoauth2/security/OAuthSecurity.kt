...
class OAuthSecurity : WebSecurityConfigurerAdapter() {
    ...
    @Bean
    fun oAuth2Service(rest: WebClient): OAuth2UserService<OAuth2UserRequest, OAuth2User> {
